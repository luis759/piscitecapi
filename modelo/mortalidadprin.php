...
class mortalidadprin_modelo{
  ...
  public function get_allcausas(){
    ...
    public function reg_mortalidadprin($IDEMP,$IDGRA,$FECHA,$RESPONSABLE,$USUARIO,$OBSERVA){
       ...
       $sql = "INSERT INTO APP6_M4RT_PR3N ( IDEMP,IDGRA,NORC,FECHA,RESPONSABLE,OBSERVACION,USUARIO,TEMPORAL,ACTIVO,VERSIONES) VALUES ( ?, ?, ?, ?, ?, ?, ?,GETDATE(), ?,?)";
       $params = array( $IDEMP,$IDGRA,$valorNORC,$FECHA,$RESPONSABLE,$OBSERVA,$USUARIO, '1', '1');
