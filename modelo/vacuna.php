...
class vacuna_modelo{
    ...
    */
    ...
    public function reg_vacuna($IDEMP,$IDGRA,$LOTE,$FECHA,$PROVEEDOR,$LABORATORIO,$TIPOVACUNA,$LOTEVACUNA,$HORAINI,$HORAFIN,$CANTIDAD,$PESO,$PERSONAS,$RESPONSABLE,$OBSERVACIONES,$ANEXO,$USUARIO){
       ...
       $sql = "INSERT INTO APP2_V1C5 (NORC,IDEMP,IDGRA,LOTE,FECHA,PROVEEDOR,LABORATORIO,TIPOVACUNA,LOTEVACUNA,HORAINI,HORAFIN,CANTIDAD,PESO,PERSONAS,RESPONSABLE,OBSERVACIONES,ANEXO,USUARIO,ACTIVO,TEMPORAL,VERSIONES) VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
       $params = array($valorNORC, $IDEMP,$IDGRA,$LOTE,$FECHA,$PROVEEDOR,$LABORATORIO,$TIPOVACUNA,$LOTEVACUNA,$HORAINI,$HORAFIN,$CANTIDAD,$PESO,$PERSONAS,$RESPONSABLE,$OBSERVACIONES,$ANEXO,$USUARIO,1, date("Y-m-d H:i:s"), '1');
